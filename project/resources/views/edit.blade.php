    ...
    <section class="content">
                ...
                <div class="box-body box box-primary">
                    <form method="POST" action="/edit/{{$test->id}}">
                        @csrf
                        <h3>Adding questions to {{ $test->name }} Test</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Existing Question to {{$test->name}} Test</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body ">
...
<a href="/delete/{{$question->id}}">Delete Question</a></td> 
                </tr>
                @endforeach
              </tbody>
              </table>
