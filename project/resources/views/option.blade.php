  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i ></i> Test</a></li>
        <li><a href="#"><i ></i> Question</a></li>
        <li><a href="#"><i ></i> Option</a></li>
                ...
                <div class="box-body box box-primary">
                    <form method="POST" action="{{ route('options') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="isCorrect" type="text" class="form-control @error('isCorrect') is-invalid @enderror" name="isCorrect" value="{{ old('isCorrect') }}" required autocomplete="isCorrect" data-container=".row" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Must be at 0 or 1" placeholder="Enter 1 if correct else 0">
                    ...
                    <a href="{{ route('dashboard') }}"> <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Add more question to Test') }}
                                </button>
                            </div></a>

                </div>
                <a href="{{ route('test') }}"> <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Create New Test') }}
                                </button>
