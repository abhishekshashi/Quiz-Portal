...
<html>
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('porto/HTML/img/faveo.png')}}" type="image/x-icon" />
    <link rel="apple-touch-icon" href="{{asset('porto/HTML/img/logo-corporate.png')}}">
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/fontawesome-free/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/animate/animate.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/simple-line-icons/css/simple-line-icons.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/owl.carousel/assets/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/owl.carousel/assets/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/vendor/magnific-popup/magnific-popup.min.css')}}">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="{{asset('porto/HTML/css/theme.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/css/theme-elements.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/css/theme-blog.css')}}">
    <link rel="stylesheet" href="{{asset('porto/HTML/css/theme-shop.css')}}">
    
    <!-- Demo CSS -->


    <!-- Skin CSS -->
    <link rel="stylesheet" href="{{asset('porto/HTML/css/skins/default.css')}}"> 

    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="{{asset('porto/HTML/css/custom.css')}}">

    <!-- Head Libs -->
    <script src="{{asset('porto/HTML/vendor/modernizr/modernizr.min.js')}}"></script>
                ...
                <div class="header-row">
                  <div class="header-logo">
                    <a href="{{route('home')
                      ...
                      <img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" src="{{asset('porto/HTML/img/faveo.png')}}">
                   </a>
                  </div>
                </div>
              </div>
...
@endif
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                <h1 data-title-border>Questionnaire</h1>
              </div>
      ...
      <section >
         <div class="card-body">
          <form method="post" action = "/result/{{$tests}}">
          @csrf
      <h1><b>{{ $test }}-Questionnaire</b> </h1>
      ...
      <section class="page-header page-header-classic page-header-sm">
         <div class="card-body bg-color-white">
              ...
              @foreach($question->options as $option)
                <li><input type="radio" name="option[{{$question->id}}]" value="{{$option->id}}" {{ (is_array(old('option')) && in_array($option->id, old('option'))) ? ' checked' : '' }}> {{ $option->option}} </li>
              @endforeach
              </ol>  
              <br/>
          </div> 
            ...
            <button style="float: right;" type="submit" class="btn btn-primary">{{ __('Submit') }}</button>
            </form>
    ...
    <script src="{{asset('porto/HTML/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.appear/jquery.appear.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.easing/jquery.easing.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.cookie/jquery.cookie.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/popper/umd/popper.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/common/common.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.validation/jquery.validate.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.gmap/jquery.gmap.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/jquery.lazyload/jquery.lazyload.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/isotope/jquery.isotope.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/vide/jquery.vide.min.js')}}"></script>
    <script src="{{asset('porto/HTML/vendor/vivus/vivus.min.js')}}"></script>
    
    <!-- Theme Base, Components and Settings -->
    <script src="{{asset('porto/HTML/js/theme.js')}}"></script>
    
    <!-- Theme Custom -->
    <script src="{{asset('porto/HTML/js/custom.js')}}"></script>
    
    <!-- Theme Initialization Files -->
    <script src="{{asset('porto/HTML/js/theme.init.js')}}"></script>
